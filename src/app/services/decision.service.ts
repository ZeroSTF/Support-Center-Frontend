...
export class DecisionService {
  ...
  createDecision(
    ...
    return this.http.post(
      `${this.apiUrl}?reclamationId=${reclamationId}&adminId=${adminId}`,
      decision
    );
  }
  ...
  getDecisionByRecId(id: number): Observable<any> {
    return this.http.get(`${this.apiUrl}/getDecisionByRecId/${id}`);
  }
